      ...
      <div class="main-sidebar" style="background-color:black;">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li >
              <li><a class="nav-link" href="payment.php"><i class="fa fa-user"></i> <span>Add Payment</span></a></li>

              <li >
              <li><a class="nav-link" href="paymentmethod.php"><i class="fa fa-user"></i> <span>Payment Method</span></a></li>

              <li >
              <li><a class="nav-link" href="wallethistory.php"><i class="fa fa-user"></i> <span>Edit Wallet</span></a></li>

              <li >
              <li><a class="nav-link" href="payhistory.php"><i class="fa fa-user"></i> <span>Payment History</span></a></li>
